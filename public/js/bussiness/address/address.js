...
var openControlDialog = function(addressName,addressId){
    ...
    htmlStr +='<a class="btn" onclick="sendControl(\'projector-Start\')">投影开启</a>';
    htmlStr +='<a class="btn" onclick="sendControl(\'projector-Close\')">投影关闭</a>';
    htmlStr +='<a class="btn" onclick="sendControl(\'projector-Change\')">投影切白</a>';
    htmlStr +='</div><br>';
